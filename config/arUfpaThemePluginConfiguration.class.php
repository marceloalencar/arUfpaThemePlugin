...
class arUfpaThemePluginConfiguration extends arDominionB5PluginConfiguration
{
    public static $summary = 'Theme plugin, extension of arDominionB5Plugin. Tema para o AtoM da Universidade Federal do Pará.';
